...
class PartnersController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Partners->save($partner)) {
                $this->Flash->success(__('The {0} has been saved.', 'Partner'));

                return $this->redirect(['action' => 'index']);
            }
            $this->Flash->error(__('The {0} could not be saved. Please, try again.', 'Partner'));
        }
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Partners->delete($partner)) {
            $this->Flash->success(__('The {0} has been deleted.', 'Partner'));
        } else {
            $this->Flash->error(__('The {0} could not be deleted. Please, try again.', 'Partner'));
        }
