        ...
        <div class="box box-primary">
          ...
          <?php echo $this->Form->create($exposico, ['type' => 'file']); ?>
            <div class="box-body">
              ...
              echo $this->Form->control('data', ['label' => 'Data Inícial','type' => 'string', 'class' => 'form-control string-date']);
              echo $this->Form->control('data_final', ['type' => 'string', 'class' => 'form-control string-date']);
              echo $this->Form->control('capa', ['type' => 'file']);
              echo '<span style="color: red">Dimensões recomendadas 600 x 600px</span>';
              echo $this->Form->control('profissional',['label' => 'Nome do artísta']);
              echo $this->Form->control('foto', ['type' => 'file','foto' => 'Nome do artísta']);
