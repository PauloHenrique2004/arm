                            ...
                            <div class="product-wrapper mb-35">
                                <div class="product-img">
                                    <a href="/produto/<?=$item->id ?>">
                                           <img class="img-prod" src="<?= "/files/Products/capa/" . $item->capa ?>" alt="">
                                    </a>
                                ...
                                <div class="product-content">
                                    <div class="product-title-wishlist">
                                        <div class="product-title-3">
                                            <h4><a href="/produto/<?=$item->id ?>"><?= $item->name ?></a></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="product-list-details">
                                    <h2><a href="/produto/<?=$item->id ?>"><?= $item->name ?></a></h2>
                                    ...
                                    <div class="shop-list-cart">
                                        <a href="/produto/<?=$item->id ?>"><i class=""></i> Ver Mais</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="qwick-view-content">
                            ...
                            <div class="quickview-plus-minus">
                                <div class="quickview-btn-cart">
                                    <a class="btn-style cr-btn" href="/produto/<?=$item->id?>"><span>Ver Mais</span></a>
                                </div>
