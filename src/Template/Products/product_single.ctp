                            ...
                            <?php foreach ($imagens as $key => $imagem): ?>
                                <div class="tab-pane <?= $key == 0 ? 'active' : '' ?>" id="pro-details<?= $key+1 ?>">
                                    <div class="easyzoom easyzoom--overlay">
                                        <a href="<?= "/files/ProdutoImages/imagem/" . $imagem->imagem ?>">
                                            <img src="<?= "/files/ProdutoImages/imagem/" . $imagem->imagem ?>" alt="">
                                        </a>
                                    </div>
                                </div>
                            <?php endforeach;?>
            ...
            <div class="col-lg-6">
                <div class="product-details-content">
                    <div class="product-overview">
                        <h5 class="pd-sub-title"><?= $productSingle->name ?></h5>
                        <?= $productSingle->description ?>
                    </div>
                    <div class="product-price" style="margin-bottom: 10px">
                        <span>R$  <?= $productSingle->preco  ?></span>
                    </div>
                    <div class="quickview-plus-minus">
                        <div class="quickview-btn-cart">
                            <a href="<?= "https://api.whatsapp.com/send?l=pt&phone=5582999261370&text=Quero comprar {$productSingle->name}!%0a%0ahttp://{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}" ?>"
...
<meta property="og:image" content="https://<?= $_SERVER['HTTP_HOST'] . "/files/Products/capa/thumb-" . $productSingle->capa ?>"/>
