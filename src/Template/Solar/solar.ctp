    ...
    <div class="container">
        <div class="row">
                    ...
                    <div class="container-fluid" style="">
                        ...
                        <div id="my-pics" class="carousel slide" data-ride="carousel"
                            ...
                            <ol class="carousel-indicators">
                                <?php foreach ($solarImages as $key => $solarImage): ?>
                                ...
                                <?php foreach ($solarImages as $key => $solarImage): ?>
                                    <div class="item <?= $key == 0 ? 'active' : '' ?>">
                                        <img style="width: 600px; height: auto !important;"
                                             src="<?= "/files/SolarImages/photo/" . $solarImage->photo ?>"
            ...
            <div id="text" style="margin-left: 29px; margin-right: 29px">
                <h2><?php echo $solar->title ?></h2>

                <p style="margin-top: -17px ;margin-right: 14px !important;
                 padding-left: 30px !important;"><?php echo $solar->description ?>  </p>
            </div>
        </div><!-- .col-md-6 end -->
