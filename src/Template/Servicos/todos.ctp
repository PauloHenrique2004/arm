                        ...
                        <div class="shop-product-wrap grid-view row">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                             ...
                             <?php endforeach;?>
                                    ...
                                    <div class="price-box">
                                        <span class="regular-price">R$ Ver</span>
                                    </div>
                                    ...
                                    <div class="product-content" id="name">
                                        <h4 style="font-size: 13px; color: #658d1c">
                                            ...
                                            <div class="single-choose-item text-right mb-md-30 mb-sm-30 comp">
                                                <?php foreach ($empresas as $empresa): ?>
                                                    <?php if($empresa->id == $item->empresa_id): ?>
                                                        <a href="https://api.whatsapp.com/send?phone=55<?= $empresa->tel_whats ?>" target="_blank"><i  id="comp" style="font-size: 30px; margin-right: 6px;color: #333333;" class="fa fa-comments"></i></a>
                                                    <?php endif; ?>
                                                <?php endforeach; ?>
                                            </div>
                                        </h4>
