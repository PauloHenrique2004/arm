 ...
 * OqueFazemosFixture
 */
class OqueFazemosFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        'iid' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['iid'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
